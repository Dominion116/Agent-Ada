/**
 * Complete Moola Market ABI slices.
 *
 * Moola is a fork of Aave v2 on Celo. These ABIs are sourced from the
 * official Aave v2 protocol ABI and verified against the Moola deployment.
 *
